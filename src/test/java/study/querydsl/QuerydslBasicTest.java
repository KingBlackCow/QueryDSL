...
//        List<Member> content = results.getResults();
    ...
    */
    ...
    //내부조인 (inner join(join) 인경우는 익숙한 where절로 해결)
    // left join (외부조인 인경우는 where절 대신 on절을 이용하자
    @Test
    ...
    @PersistenceUnit
    EntityManagerFactory emf;//em에서 가져오냐 db에서 가져오냐
    ...
    */
    ...
    //Property접근방법
    //bean방식으로 getter setter를 통해 값이 주입된것
    @Test
    ...
    @Test
    //dto에 @QueryProjection을 넣어야하기에 dto가 querydsl에 의존해진다. => 설계적으로 문제
    ...
    private BooleanExpression usernameEq(String usernameCond) {
        return usernameCond != null ? member.username.eq(usernameCond) : null;//null이면 무시가됨
    }
    ...
    public void bulkUpdate(){
        ...
        //count = 바뀐 row수
        //bulk up쿼리 단점 : 디비에는 반영되나 영속성 컨텍스트에는 반영이안됨
        ...
        //벌크업 연산이후 em을 초기화 시켜 다시 디비에서 가져올라고고
        em.flush();
        em.clear();
    }
